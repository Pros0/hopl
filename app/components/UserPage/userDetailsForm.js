...
import { UserForm, Card, ButtonsWrapper } from './styles';
        ...
        return (
          <Card>
            ...
            <UserForm onSubmit={handleSubmit}>
              ...
              <TextField
                label={formatMessage(messages.driversLicenseInputPlaceholder)}
                name="driversLicense"
            ...
            {saveUserDetailsResponse && (
              <Alert
                severity={saveUserDetailsResponse.error ? 'error' : 'success'}
              >
